...
for row in sheet.rows:
    if(row[0].value == None):                   #for cleaning numbers
        a = str(row[0].value)
        b = "+" + "639" + str(random.randint(0, 9)) + "***" + str(random.randint(0, 9)) + str(random.randint(0, 9))+ str(random.randint(0, 9))+ str(random.randint(0, 9))+ str(random.randint(0, 9))
        row[0].value = b
